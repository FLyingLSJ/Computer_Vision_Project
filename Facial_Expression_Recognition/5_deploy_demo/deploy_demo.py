...
PREDICTOR_PATH = "./face_detector_trained/shape_predictor_68_face_landmarks.dat"
predictor = dlib.shape_predictor(PREDICTOR_PATH)  # 关键点检测
# 配置人脸检测器路径
cascade_path = "./face_detector_trained/haarcascade_frontalface_default.xml"  # 在 opencv github 可以找到
# 初始化分类器
